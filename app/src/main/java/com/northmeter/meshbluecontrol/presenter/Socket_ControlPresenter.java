...
public class Socket_ControlPresenter {
    private Context context;
    public Socket_ControlPresenter(Context context){
     ...
     * 写数据
     * 控制制码：读数据 C=14 正常应答 C=94  异常应答 　C=D4
     * 97	20	01	01(CA533434 反向为343453CA)	xx	1			*	跳闸（数据域需为0x0f）
     *97	20	01	02(CA533435 反向为353453CA)	xx	1			*	合闸（数据域需为0x0f）
     * */
    public String getOpenOrCloseData(String fatherNum,String childNum ,boolean openOrclose){//BD 00 000000000000 04 0700 01B5 01000000000000  cs 16
        ...
        String childData = "68"+ Udp_Help.reverseRst(childNum)+"68140D"+ocFlag+ Constants.HandlerKey+"42";
        String childCs = Udp_Help.get_sum(childData)+"16";
