...
import com.jmesh.blebase.exception.GattException;
...
import com.jmesh.blebase.state.BleWriteState;

import java.util.UUID;

@TargetApi(Build.VERSION_CODES.JELLY_BEAN_MR2)
public class BleConnector {
    public static final String LogTag = BleConnector.class.getSimpleName();
    ...
    BleConnector(final BleBluetooth bleBluetooth) {
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    ...
                    case BleMsg.MSG_CHA_NOTIFY_RESULT: {
                        ...
                        if (notifyCallback != null) {
                            if (status == BluetoothGatt.GATT_SUCCESS) {
                                notifyCallback.onNotifySuccess(bleBluetooth.getDeviceKey(), notifyCallback.getNotifyInstanceId(), notifyCallback.getNotifyUUID());
                            } else {
                    ...
                    case BleMsg.MSG_CHA_NOTIFY_DATA_CHANGE: {
                        ...
                        if (notifyCallback != null) {
                            notifyCallback.onCharacteristicChanged(value, notifyCallback.getNotifyInstanceId(), notifyCallback.getNotifyUUID());
                        }
                        break;
                    }
    ...
    public boolean isNotificaionEnable;
    ...
    public void enableCharacteristicNotify(BleNotifyCallback bleNotifyCallback, String uuid_notify) {
        if (mCharacteristic != null
            ...
            isNotificaionEnable = setCharacteristicNotification(mBluetoothGatt, mCharacteristic, true, bleNotifyCallback);
        } else {
    ...
    private boolean setCharacteristicNotification(BluetoothGatt gatt,
                                                  ...
                                                  boolean enable, BleNotifyCallback bleNotifyCallback) {
