...
public class SplitWriter {
    public static final String LogTag = SplitWriter.class.getSimpleName();
                    ...
                    .writeCharacteristic(data,
                            new BleWriteCallback() {
                                ...
                                public void onWriteSuccess(int current, int total, byte[] justWrite) {
                                    ...
                                    if (mCallback != null) {
                                        Log.e(LogTag,"onSplit_writesuccess");
    ...
    private static Queue<byte[]> splitByte(byte[] data, int count) {
        if (count > 20) {
            Log.w(LogTag,"Be careful: split count beyond 20! Ensure MTU higher than 23!");
        }
